...
$TPP_i = \beta_0 + \beta_1*MedianAge_i + \beta_2*BornSEEurope_i + \beta_3*ExtractiveJobs_i + \beta_4*AdminJobs_i + \beta_5*RentLoan_i + \beta_6*NoReligion_i + \beta_7*OneParentHouse_i + \beta_8*BornUK_i + \beta_9*Education_i + \beta_{10}*CurrentlyStudying_i + \beta_{11}*MedianAge_i*Education_i + \beta_{12}*ExtractiveJobs_i*AdminJobs_i + \beta_{13}*OneParentHouse_i*Education_i + \beta_{14}*AdminJobs_i*Education_i + \varepsilon_i$
