...
A table of the sums of Akaike weights for all variables, in each year, is given in Appendix \@ref(a:allSAW). Additionally, scatterplots of the response against each variable contained in this superset may be found in Appendix \@ref(a:scatterplots).
