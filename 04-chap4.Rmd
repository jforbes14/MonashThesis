...
Model diagnostics are conducted in Appendix \@ref(a:diagnostics), including tests for heteroskedasticity, residual non-normality, non-linear patterns in the residuals against included predictors, patterns in the residuals against missing predictors and influential points.
