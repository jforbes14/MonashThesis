...
To estimate a *good* model, we aim to produce a superset that captures the five *most important* variables in determining $TPP$ in each election. Five is chosen because we see significant drop-off in R^2 after 5 variables???. Our approach is based off a technique common in ecological studies, using Akaike weights to measure relative variable importance (@BurnhamAnderson2002).
