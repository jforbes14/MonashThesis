...
```{r vis-relig, out.height='25%', fig.cap="Distributions of the proportions of the electoral populations not identifying with a religion, by election year. Over time, the higher proportions of electorates are not identifying with a religion."}
profiles %>% 
