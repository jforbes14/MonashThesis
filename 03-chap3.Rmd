...
```{r vis-age, fig.cap="Distribution of median age across Australian electorates, by election year"}
profiles %>% 
...
```{r visrg, fig.cap="Distribution of no religion across Australian electorates, by election year"}
profiles %>% 
...
```{r vis-educ, fig.cap="Distribution of across Australian electorates, by election year"}
profiles %>% 
