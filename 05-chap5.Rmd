...
In the 2001 and 2004 elections, `CurrentlyStudying` is estimated to have a negative, albeit insignficant effect. From 2007, there is a distint change, as the slopes in Figure \@ref(fig:studying) are positive for these elections. Only in 2010 is this positive relationship significant (by the horizontal line test).
