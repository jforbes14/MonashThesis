...
```{r rawSE, out.width="100%"}
## Voting against Born_SE_Europe
data_mod %>% ggplot(aes(x = Born_SE_Europe, y = Perc_LNP)) + geom_point() + geom_smooth(method = "lm") + facet_wrap(~year)
```
...
all_coefs %>% filter(term == "Born_SE_Europe") %>% 
  ...
  geom_point(size = 5) + geom_linerange(aes(ymin = lower95, ymax = upper95), size = 3) + 
...
grid.arrange(Born_SE_01, Born_SE_04, Born_SE_07, Born_SE_10, Born_SE_13, Born_SE_16, 
             nrow = 2, 
             #top = textGrob("South-Eastern European Influence", gp = gpar(cex = 1.8)), 
             left = textGrob("Two-party preferred vote (%)", gp = gpar(cex = 1.8), rot = 90), 
             bottom = textGrob("Population born in South-Eastern Europe (relative)", gp = gpar(cex = 1.8)))
```
...
grid.arrange(Born_UK_01, Born_UK_04, Born_UK_07, Born_UK_10, Born_UK_13, Born_UK_16, 
             ...
             #top = textGrob("South-Eastern European Influence", gp = gpar(cex = 1.8)), 
             left = textGrob("Two-party preferred vote (%)", gp = gpar(cex = 1.8), rot = 90), 
             bottom = textGrob("Population born in the United Kingdom (relative)", gp = gpar(cex = 1.8)))
```
...
grid.arrange(NoReligion_01, NoReligion_04, NoReligion_07, NoReligion_10, NoReligion_13, NoReligion_16, 
             ...
             #top = textGrob("South-Eastern European Influence", gp = gpar(cex = 1.8)), 
             left = textGrob("Two-party preferred vote (%)", gp = gpar(cex = 1.8), rot = 90), 
             bottom = textGrob("Population not identifying with a religion (relative)", gp = gpar(cex = 1.8)))
```
...
Educ_Age_16 <- educage_df %>% ggplot(aes(x=Educ, y=MedianAge)) +
  ...
  theme_bw() + 
  theme(plot.title = element_text(face = "bold", size = 14, hjust = 0.5)) + geom_point(aes(x=Educ,y=MedianAge), data = data_mod %>% filter(year == "2016"), alpha = 0.5) +  
...
Educ_Age_13 <- educage_df %>% ggplot(aes(x=Educ, y=MedianAge)) +
  ...
  theme_bw() + 
  theme(plot.title = element_text(face = "bold", size = 14, hjust = 0.5)) + geom_point(aes(x=Educ,y=MedianAge), data = data_mod %>% filter(year == "2013"), alpha = 0.5) +  
  scale_fill_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
Educ_Age_10 <- educage_df %>% ggplot(aes(x=Educ, y=MedianAge)) +
  ...
  theme_bw() + 
  theme(plot.title = element_text(face = "bold", size = 14, hjust = 0.5)) + geom_point(aes(x=Educ,y=MedianAge), data = data_mod %>% filter(year == "2010"), alpha = 0.5) +  
  scale_fill_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
Educ_Age_07 <- educage_df %>% ggplot(aes(x=Educ, y=MedianAge)) +
  ...
  theme_bw() + 
  theme(plot.title = element_text(face = "bold", size = 14, hjust = 0.5)) + geom_point(aes(x=Educ,y=MedianAge), data = data_mod %>% filter(year == "2007"), alpha = 0.5) +  
  scale_fill_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
Educ_Age_04 <- educage_df %>% ggplot(aes(x=Educ, y=MedianAge)) +
  ...
  theme_bw() + 
  theme(plot.title = element_text(face = "bold", size = 14, hjust = 0.5)) + geom_point(aes(x=Educ,y=MedianAge), data = data_mod %>% filter(year == "2004"), alpha = 0.5) +  
  scale_fill_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
Educ_Age_01 <- educage_df %>% ggplot(aes(x=Educ, y=MedianAge)) +
  ...
  theme_bw() + 
  theme(plot.title = element_text(face = "bold", size = 14, hjust = 0.5)) + geom_point(aes(x=Educ,y=MedianAge), data = data_mod %>% filter(year == "2001"), alpha = 0.5) +  
  scale_fill_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
grid.arrange(Educ_Age_01, Educ_Age_04, Educ_Age_07, Educ_Age_10, Educ_Age_13, Educ_Age_16, 
             nrow = 2, 
             #top = textGrob("South-Eastern European Influence", gp = gpar(cex = 1.8)), 
             bottom = textGrob("Education levels", gp = gpar(cex = 1.8)), 
             left = textGrob("Median age", gp = gpar(cex = 1.8), rot = 90))

```
```{r educage_scale, out.width = "20%"}
## TPP scale
TPP_scale <- readPNG("./images/TPP_scale.png")
...
Educ_OP_16 <- educOP_df %>% ggplot(aes(x=Educ, y=OneParent_House)) +
  ...
  labs(x = "", y = "", fill = "Marginal effect on two-party preferred (%)", title = "2016") +
  theme_bw() + 
  theme(plot.title = element_text(face = "bold", size = 14, hjust = 0.5)) + geom_point(aes(x=Educ,y=OneParent_House), data = data_mod %>% filter(year == "2016"), alpha = 0.5) +  
  scale_fill_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
Educ_OP_13 <- educOP_df %>% ggplot(aes(x=Educ, y=OneParent_House)) +
  ...
  labs(x = "", y = "", fill = "Marginal effect on two-party preferred (%)", title = "2013") +
  theme_bw() + 
  theme(plot.title = element_text(face = "bold", size = 14, hjust = 0.5)) + geom_point(aes(x=Educ,y=OneParent_House), data = data_mod %>% filter(year == "2013"), alpha = 0.5) +  
  scale_fill_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
Educ_OP_10 <- educOP_df %>% ggplot(aes(x=Educ, y=OneParent_House)) +
  ...
  labs(x = "", y = "", fill = "Marginal effect on two-party preferred (%)", title = "2010") +
  theme_bw() + 
  theme(plot.title = element_text(face = "bold", size = 14, hjust = 0.5)) + geom_point(aes(x=Educ,y=OneParent_House), data = data_mod %>% filter(year == "2010"), alpha = 0.5) +  
  scale_fill_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
Educ_OP_07 <- educOP_df %>% ggplot(aes(x=Educ, y=OneParent_House)) +
  ...
  labs(x = "", y = "", fill = "Marginal effect on two-party preferred (%)", title = "2007") +
  theme_bw() + 
  theme(plot.title = element_text(face = "bold", size = 14, hjust = 0.5)) + geom_point(aes(x=Educ,y=OneParent_House), data = data_mod %>% filter(year == "2007"), alpha = 0.5) +  
  scale_fill_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
Educ_OP_04 <- educOP_df %>% ggplot(aes(x=Educ, y=OneParent_House)) +
  ...
  labs(x = "", y = "", fill = "Marginal effect on two-party preferred (%)", title = "2004") +
  theme_bw() + 
  theme(plot.title = element_text(face = "bold", size = 14, hjust = 0.5)) + geom_point(aes(x=Educ,y=OneParent_House), data = data_mod %>% filter(year == "2004"), alpha = 0.5) +  
  scale_fill_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
Educ_OP_01 <- educOP_df %>% ggplot(aes(x=Educ, y=OneParent_House)) +
  ...
  labs(x = "", y = "", fill = "Marginal effect on two-party preferred (%)", title = "2001") +
  theme_bw() + 
  theme(plot.title = element_text(face = "bold", size = 14, hjust = 0.5)) + geom_point(aes(x=Educ,y=OneParent_House), data = data_mod %>% filter(year == "2001"), alpha = 0.5) +  
  scale_fill_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
grid.arrange(Educ_OP_01, Educ_OP_04, Educ_OP_07, Educ_OP_10, Educ_OP_13, Educ_OP_16, 
             ...
             #top = textGrob("South-Eastern European Influence", gp = gpar(cex = 1.8)), 
             bottom = textGrob("Education levels", gp = gpar(cex = 1.8)), 
             left = textGrob("Proportion of single parent households", gp = gpar(cex = 1.8), rot = 90))

```

```{r educOP_scale, out.width = "20%"}
## TPP scale
TPP_scale <- readPNG("./images/TPP_scale.png")
 grid.raster(TPP_scale)
```
...
Extractive_Office_16 <- jobs_df %>% ggplot(aes(x=Extractive, y=ManagerAdminClericalSales)) +
  ...
  labs(x = "", y = "", fill = "Marginal effect on two-party preferred (%)", title = "2016") +
  theme_bw() + 
  theme(plot.title = element_text(face = "bold", size = 14, hjust = 0.5)) + geom_point(aes(x=Extractive,y=ManagerAdminClericalSales), data = data_mod %>% filter(year == "2016"), alpha = 0.5) +  
  scale_fill_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
Extractive_Office_13 <- jobs_df %>% ggplot(aes(x=Extractive, y=ManagerAdminClericalSales)) +
  ...
  labs(x = "", y = "", fill = "Marginal effect on two-party preferred (%)", title = "2013") +
  theme_bw() + 
  theme(plot.title = element_text(face = "bold", size = 14, hjust = 0.5)) + geom_point(aes(x=Extractive,y=ManagerAdminClericalSales), data = data_mod %>% filter(year == "2013"), alpha = 0.5) +  
  scale_fill_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
Extractive_Office_10 <- jobs_df %>% ggplot(aes(x=Extractive, y=ManagerAdminClericalSales)) +
  ...
  labs(x = "", y = "", fill = "Marginal effect on two-party preferred (%)", title = "2010") +
  theme_bw() + 
  theme(plot.title = element_text(face = "bold", size = 14, hjust = 0.5)) + geom_point(aes(x=Extractive,y=ManagerAdminClericalSales), data = data_mod %>% filter(year == "2010"), alpha = 0.5) +  
  scale_fill_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
Extractive_Office_07 <- jobs_df %>% ggplot(aes(x=Extractive, y=ManagerAdminClericalSales)) +
  ...
  labs(x = "", y = "", fill = "Marginal effect on two-party preferred (%)", title = "2007") +
  theme_bw() + 
  theme(plot.title = element_text(face = "bold", size = 14, hjust = 0.5)) + geom_point(aes(x=Extractive,y=ManagerAdminClericalSales), data = data_mod %>% filter(year == "2007"), alpha = 0.5) +  
  scale_fill_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
Extractive_Office_04 <- jobs_df %>% ggplot(aes(x=Extractive, y=ManagerAdminClericalSales)) +
  ...
  labs(x = "", y = "", fill = "Marginal effect on two-party preferred (%)", title = "2004") +
  theme_bw() + 
  theme(plot.title = element_text(face = "bold", size = 14, hjust = 0.5)) + geom_point(aes(x=Extractive,y=ManagerAdminClericalSales), data = data_mod %>% filter(year == "2004"), alpha = 0.5) +  
  scale_fill_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
Extractive_Office_01 <- jobs_df %>% ggplot(aes(x=Extractive, y=ManagerAdminClericalSales)) +
  ...
  labs(x = "", y = "", fill = "Marginal effect on two-party preferred (%)", title = "2001") +
  theme_bw() + 
  theme(plot.title = element_text(face = "bold", size = 14, hjust = 0.5)) + geom_point(aes(x=Extractive,y=ManagerAdminClericalSales), data = data_mod %>% filter(year == "2001"), alpha = 0.5) +  
  scale_fill_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
grid.arrange(Extractive_Office_01, Extractive_Office_04, Extractive_Office_07, Extractive_Office_10, Extractive_Office_13, Extractive_Office_16, 
             nrow = 2, 
             bottom = textGrob("Extractive jobs", gp = gpar(cex = 1.8)), 
             left = textGrob("Administrative jobs", gp = gpar(cex = 1.8), rot = 90))

```

```{r jobs_scale, out.width="20%"}
## TPP scale
TPP_scale <- readPNG("./images/TPP_scale.png")
 grid.raster(TPP_scale)
```
...
Educ_Admin_16 <- admineduc_df %>% ggplot(aes(x=Educ, y=ManagerAdminClericalSales)) +
  ...
  labs(x = "", y = "", fill = "Marginal effect on two-party preferred (%)", title = "2016") +
  theme_bw() + 
  theme(plot.title = element_text(face = "bold", size = 14, hjust = 0.5)) + geom_point(aes(x=Educ,y=ManagerAdminClericalSales), data = data_mod %>% filter(year == "2016"), alpha = 0.5) +  
  scale_fill_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
Educ_Admin_13 <- admineduc_df %>% ggplot(aes(x=Educ, y=ManagerAdminClericalSales)) +
  ...
  labs(x = "", y = "", fill = "Marginal effect on two-party preferred (%)", title = "2013") +
  theme_bw() + 
  theme(plot.title = element_text(face = "bold", size = 14, hjust = 0.5)) + geom_point(aes(x=Educ,y=ManagerAdminClericalSales), data = data_mod %>% filter(year == "2013"), alpha = 0.5) +  
  scale_fill_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
Educ_Admin_10 <- admineduc_df %>% ggplot(aes(x=Educ, y=ManagerAdminClericalSales)) +
  ...
  labs(x = "", y = "", fill = "Marginal effect on two-party preferred (%)", title = "2010") +
  theme_bw() + 
  theme(plot.title = element_text(face = "bold", size = 14, hjust = 0.5)) + geom_point(aes(x=Educ,y=ManagerAdminClericalSales), data = data_mod %>% filter(year == "2010"), alpha = 0.5) +  
  scale_fill_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
Educ_Admin_07 <- admineduc_df %>% ggplot(aes(x=Educ, y=ManagerAdminClericalSales)) +
  ...
  labs(x = "", y = "", fill = "Marginal effect on two-party preferred (%)", title = "2007") +
  theme_bw() + 
  theme(plot.title = element_text(face = "bold", size = 14, hjust = 0.5)) + geom_point(aes(x=Educ,y=ManagerAdminClericalSales), data = data_mod %>% filter(year == "2007"), alpha = 0.5) +  
  scale_fill_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
Educ_Admin_04 <- admineduc_df %>% ggplot(aes(x=Educ, y=ManagerAdminClericalSales)) +
  ...
  labs(x = "", y = "", fill = "Marginal effect on two-party preferred (%)", title = "2004") +
  theme_bw() + 
  theme(plot.title = element_text(face = "bold", size = 14, hjust = 0.5)) + geom_point(aes(x=Educ,y=ManagerAdminClericalSales), data = data_mod %>% filter(year == "2004"), alpha = 0.5) +  
  scale_fill_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
Educ_Admin_01 <- admineduc_df %>% ggplot(aes(x=Educ, y=ManagerAdminClericalSales)) +
  ...
  labs(x = "", y = "", fill = "Marginal effect on two-party preferred (%)", title = "2001") +
  theme_bw() + 
  theme(plot.title = element_text(face = "bold", size = 14, hjust = 0.5)) + geom_point(aes(x=Educ,y=ManagerAdminClericalSales), data = data_mod %>% filter(year == "2001"), alpha = 0.5) +  
  scale_fill_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
grid.arrange(Educ_Admin_01, Educ_Admin_04, Educ_Admin_07, Educ_Admin_10, Educ_Admin_13, Educ_Admin_16, 
             nrow = 2, 
             bottom = textGrob("Education level", gp = gpar(cex = 1.8)), 
             left = textGrob("Administrative jobs", gp = gpar(cex = 1.8), rot = 90))

```

```{r admineduc_scale, out.width="20%"}
## TPP scale
TPP_scale <- readPNG("./images/TPP_scale.png")
 grid.raster(TPP_scale)
```
