...
```{r norelig2, fig.cap="Partial residual plots against proportion of electorate population not identifying with a religion, with a line illustrating the modelled effect in each election.}
...
```{r model_fit, fig.cap = "Fitted versus actual two-party preferred vote in each election"}
aug_all %>% 
