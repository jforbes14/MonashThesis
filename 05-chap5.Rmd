...
```{r SE1, out.width='100%', fig.cap="Partial residual plots for the effect of population born in South-Eastern Europe, across election years."}
...
```{r SE2, out.width='75%', fig.cap="Estimated coefficients for the population born in South-Eastern Europe, across election years and with 95\\% confidence bands."}
# Coefficients
...
```{r norelig1, fig.cap="Partial residual plots for the effect of the population proportion not identifying with a religion, across election years."}
...
```{r norelig2, out.width='75%', fig.cap="Estimated coefficients for population proportion not identifying with a religion, across election years and with 95\\% confidence bands."}
# Coefficients
...
```{r studying, fig.cap="Partial residual plots for the effect of student populations, across election years."}
...
```{r studying2, out.width='75%', fig.cap="Estimated coefficients for population currently studying, across election years and with 95\\% confidence bands."}
# Coefficients
...
```{r educage, fig.cap="Raster plot of the predicted two-party preferred vote for combinations of education and median age, in each election year."}
...
```{r educOP, fig.cap="Raster plot of the predicted two-party preferred vote for combinations of education levels and the proportion of single parent households, in each election year."}
...
```{r jobs1, fig.cap="Raster plot of the predicted two-party preferred vote for combinations of extractive jobs and administrative jobs, in each election year."}
jobs_df <- data.frame(
