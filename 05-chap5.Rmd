...
There are four two-way interactions in the final model. For each interaction, 2D heatmaps are used to illustrate the predicted effect of the interacted variables, using colour. White regions represent a combination of the two variables that are predicted to have the same two-party preference as an electorate with mean characteristics, whereas strong red regions identify with the Labor party, and blue are stronger supporters of the Liberal party. For the purpose of illustration, the colour scale of each 2D heatmap is set so that an electorate with mean characteristics has a two-party preferred vote of 50%. Points for the electorates are overlaid on the 2D heatmaps, which are coloured by their partial residuals (see Chapter \@ref(maineff) for a description of partial residuals).
...
Educ_Age_16 <- educage_df %>% ggplot(aes(x=Education, y=MedianAge)) +
  ...
  geom_point(aes(x=Education,y=MedianAge, col=partials16), alpha = 0.7, data = data_mod %>% filter(year == "2016"), size = 1) +  
  geom_point(aes(x=Education,y=MedianAge), shape = 1, data = data_mod %>% filter(year == "2016"), alpha = 0.2, size = 1) +  
...
Educ_Age_13 <- educage_df %>% ggplot(aes(x=Education, y=MedianAge)) +
  ...
  geom_point(aes(x=Education,y=MedianAge,col=partials13), alpha = 0.7, data = data_mod %>% filter(year == "2013"), size = 1) + 
  geom_point(aes(x=Education,y=MedianAge), shape = 1, alpha = 0.2, data = data_mod %>% filter(year == "2013"), size = 1) +  
  scale_color_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
Educ_Age_10 <- educage_df %>% ggplot(aes(x=Education, y=MedianAge)) +
  ...
  geom_point(aes(x=Education,y=MedianAge, col=partials10), alpha = 0.7, data = data_mod %>% filter(year == "2010"), size = 1) +  
  geom_point(aes(x=Education,y=MedianAge), shape = 1, alpha = 0.2,  data = data_mod %>% filter(year == "2010"), size = 1) +  
  scale_color_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
Educ_Age_07 <- educage_df %>% ggplot(aes(x=Education, y=MedianAge)) +
  ...
  geom_point(aes(x=Education,y=MedianAge, col=partials07), alpha = 0.7, data = data_mod %>% filter(year == "2007"), size = 1) +  
  geom_point(aes(x=Education,y=MedianAge), shape = 1, alpha = 0.2, data = data_mod %>% filter(year == "2007"), size = 1) +  
  scale_color_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
Educ_Age_04 <- educage_df %>% ggplot(aes(x=Education, y=MedianAge)) +
  ...
  geom_point(aes(x=Education,y=MedianAge, col=partials04), alpha = 0.7, data = data_mod %>% filter(year == "2004"), size = 1) + 
  geom_point(aes(x=Education,y=MedianAge), shape = 1, alpha = 0.2, data = data_mod %>% filter(year == "2004"), size = 1) + 
  scale_color_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
Educ_Age_01 <- educage_df %>% ggplot(aes(x=Education, y=MedianAge)) +
  ...
  geom_point(aes(x=Education,y=MedianAge, col=partials01), alpha = 0.7, data = data_mod %>% filter(year == "2001", !is.na(Perc_LNP)), size = 1) +  
  geom_point(aes(x=Education,y=MedianAge), alpha = 0.2, shape = 1, data = data_mod %>% filter(year == "2001", !is.na(Perc_LNP)), size = 1) +  
  scale_color_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
...
Educ_OP_16 <- educOP_df %>% ggplot(aes(x=Education, y=OneParentHouse)) +
  ...
  geom_point(aes(x=Education,y=OneParentHouse, col=partials16), alpha = 0.7, data = data_mod %>% filter(year == "2016"), size = 1) +
  geom_point(aes(x=Education,y=OneParentHouse), alpha = 0.2, shape = 1, data = data_mod %>% filter(year == "2016"), size = 1) +
  scale_color_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
                       values = scales::rescale(c(min(partials16), -8, -4, -2, 
                                                  0, 2, 4, 8, max(partials16)))) +  
  guides(fill = FALSE, col = FALSE) +
...
Educ_OP_13 <- educOP_df %>% ggplot(aes(x=Education, y=OneParentHouse)) +
  ...
  geom_point(aes(x=Education,y=OneParentHouse,col=partials13), alpha = 0.7, data = data_mod %>% filter(year == "2013"), size = 1) +
  geom_point(aes(x=Education,y=OneParentHouse), alpha = 0.2, shape=1, data = data_mod %>% filter(year == "2013"), size = 1) +
  scale_color_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
                       values = scales::rescale(c(min(partials13), -8, -4, -2, 
                                                  0, 2, 4, 8, max(partials13)))) +  
  guides(fill = FALSE, col = FALSE) +
...
Educ_OP_10 <- educOP_df %>% ggplot(aes(x=Education, y=OneParentHouse)) +
  ...
  geom_point(aes(x=Education,y=OneParentHouse, col=partials10), alpha = 0.7, data = data_mod %>% filter(year == "2010"), size = 1) +
  geom_point(aes(x=Education,y=OneParentHouse), shape = 1, alpha = 0.2,  data = data_mod %>% filter(year == "2010"), size = 1) +  
  scale_color_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
                       values = scales::rescale(c(min(partials10), -8, -4, -2, 
                                                  0, 2, 4, 8, max(partials10)))) +  
  guides(fill = FALSE, col = FALSE) +
...
Educ_OP_07 <- educOP_df %>% ggplot(aes(x=Education, y=OneParentHouse)) +
  ...
  geom_point(aes(x=Education,y=OneParentHouse, col=partials07), alpha = 0.7, data = data_mod %>% filter(year == "2007"), size = 1) +
  geom_point(aes(x=Education,y=OneParentHouse), alpha = 0.2, shape = 1, data = data_mod %>% filter(year == "2007"), size = 1) +
  scale_color_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
                       values = scales::rescale(c(min(partials07), -8, -4, -2, 
                                                  0, 2, 4, 8, max(partials07)))) +  
  guides(fill = FALSE, col = FALSE) +
...
Educ_OP_04 <- educOP_df %>% ggplot(aes(x=Education, y=OneParentHouse)) +
  ...
  geom_point(aes(x=Education,y=OneParentHouse, col=partials04), alpha = 0.7, data = data_mod %>% filter(year == "2004"), size = 1) +
  geom_point(aes(x=Education,y=OneParentHouse), alpha = 0.2, shape = 1, data = data_mod %>% filter(year == "2004"), size = 1) +
  scale_color_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
                       values = scales::rescale(c(min(partials04), -8, -4, -2, 
                                                  0, 2, 4, 8, max(partials04)))) +  
  guides(fill = FALSE, col = FALSE) +
...
Educ_OP_01 <- educOP_df %>% ggplot(aes(x=Education, y=OneParentHouse)) +
  ...
  geom_point(aes(x=Education,y=OneParentHouse, col=partials01), alpha = 0.7, data = data_mod %>% filter(year == "2001", !is.na(Perc_LNP)), size = 1) +   
  geom_point(aes(x=Education,y=OneParentHouse), alpha = 0.2, shape = 1, data = data_mod %>% filter(year == "2001", !is.na(Perc_LNP)), size = 1) +  
  scale_color_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
                       values = scales::rescale(c(min(partials01), -8, -4, -2, 
                                                  0, 2, 4, 8, max(partials01)))) +  
  guides(fill = FALSE, col = FALSE) +
...
ExtractiveJobs_Office_16 <- jobs_df %>% ggplot(aes(x=ExtractiveJobs, y=AdminJobs)) +
  ...
  geom_point(aes(x=ExtractiveJobs,y=AdminJobs, col=partials16), alpha = 0.7, data = data_mod %>% filter(year == "2016"), size = 1) +
  geom_point(aes(x=ExtractiveJobs,y=AdminJobs), alpha = 0.2, shape = 1, data = data_mod %>% filter(year == "2016"), size = 1) +
  scale_color_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
                       values = scales::rescale(c(min(partials16), -8, -4, -2, 
                                                  0, 2, 4, 8, max(partials16)))) +  
  guides(fill = FALSE, col = FALSE) +
...
ExtractiveJobs_Office_13 <- jobs_df %>% ggplot(aes(x=ExtractiveJobs, y=AdminJobs)) +
  ...
  geom_point(aes(x=ExtractiveJobs,y=AdminJobs,col=partials13), alpha = 0.7, data = data_mod %>% filter(year == "2013"), size = 1) +
  geom_point(aes(x=ExtractiveJobs,y=AdminJobs), alpha = 0.2, shape = 1, data = data_mod %>% filter(year == "2013"), size = 1) +
  scale_color_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
                       values = scales::rescale(c(min(partials13), -8, -4, -2, 
                                                  0, 2, 4, 8, max(partials13)))) +  
  guides(fill = FALSE, col = FALSE) +
...
ExtractiveJobs_Office_10 <- jobs_df %>% ggplot(aes(x=ExtractiveJobs, y=AdminJobs)) +
  ...
  geom_point(aes(x=ExtractiveJobs,y=AdminJobs, col=partials10), alpha = 0.7, data = data_mod %>% filter(year == "2010"), size = 1) +
  geom_point(aes(x=ExtractiveJobs,y=AdminJobs), shape = 1, alpha = 0.2,  data = data_mod %>% filter(year == "2010"), size = 1) +  
  scale_color_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
                       values = scales::rescale(c(min(partials10), -8, -4, -2, 
                                                  0, 2, 4, 8, max(partials10)))) +  
  guides(fill = FALSE, col = FALSE) +
...
ExtractiveJobs_Office_07 <- jobs_df %>% ggplot(aes(x=ExtractiveJobs, y=AdminJobs)) +
  ...
  geom_point(aes(x=ExtractiveJobs,y=AdminJobs, col=partials07), alpha = 0.7, data = data_mod %>% filter(year == "2007"), size = 1) +
  geom_point(aes(x=ExtractiveJobs,y=AdminJobs), alpha = 0.2, shape = 1, data = data_mod %>% filter(year == "2007"), size = 1) +
  scale_color_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
                       values = scales::rescale(c(min(partials07), -8, -4, -2, 
                                                  0, 2, 4, 8, max(partials07)))) +  
  guides(fill = FALSE, col = FALSE) +
...
ExtractiveJobs_Office_04 <- jobs_df %>% ggplot(aes(x=ExtractiveJobs, y=AdminJobs)) +
  ...
  geom_point(aes(x=ExtractiveJobs,y=AdminJobs, col=partials04), alpha = 0.7, data = data_mod %>% filter(year == "2004"), size = 1) +
  geom_point(aes(x=ExtractiveJobs,y=AdminJobs), alpha = 0.2, shape = 1, data = data_mod %>% filter(year == "2004"), size = 1) +
  scale_color_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
                       values = scales::rescale(c(min(partials04), -8, -4, -2, 
                                                  0, 2, 4, 8, max(partials04)))) +  
  guides(fill = FALSE, col = FALSE) +
...
ExtractiveJobs_Office_01 <- jobs_df %>% ggplot(aes(x=ExtractiveJobs, y=AdminJobs)) +
  ...
  geom_point(aes(x=ExtractiveJobs,y=AdminJobs, col=partials01), alpha = 0.7, data = data_mod %>% filter(year == "2001", !is.na(Perc_LNP)), size = 1) +   
  geom_point(aes(x=ExtractiveJobs,y=AdminJobs), alpha = 0.2, shape = 1, data = data_mod %>% filter(year == "2001", !is.na(Perc_LNP)), size = 1) +  
  scale_color_gradientn(colours = c("#ff0000", "#ff6666", "#ff9999", "#ffcccc", "white", "#cce6ff", "#3399ff", "#3385ff", "#3366ff"), 
                       values = scales::rescale(c(min(partials01), -8, -4, -2, 
                                                  0, 2, 4, 8, max(partials01)))) +  
  guides(fill = FALSE, col = FALSE) +
