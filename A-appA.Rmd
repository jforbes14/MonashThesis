...
d1 <- aug_all %>% 
  ...
  theme(axis.title = element_text(size = 6), title = element_text(size = 6),
...
d2 <- aug_all %>% 
  ...
  facet_wrap(~year, nrow = 6) +
  labs(x = "Theoretical quantiles", y = "Sample residual quantiles", title = "Residual quantile-quantile\nplots") +
  theme(axis.title = element_text(size = 6), title = element_text(size = 6),
...
d3 <- aug_all %>% 
  ...
  facet_wrap(~year, nrow = 6) + 
  labs(x = "Fitted values", y = "Residuals", title = "Residuals against\nfitted values") +
  theme(axis.title = element_text(size = 6), title = element_text(size = 6),
        plot.margin=unit(c(0.2,0.2,0.2,0.2), "cm")) + coord_fixed(ratio = 0.75)
