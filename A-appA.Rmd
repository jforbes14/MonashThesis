...
```{r resvpred, fig.cap = "Residuals vs. predictors in the 2016 election model. No obvious signs of non-linearity."}
aug_all %>%
  filter(year == "2016") %>% 
  ...
  theme(plot.margin=unit(c(0.2,0.2,0.2,0.2), "cm"), axis.text = element_text(size = 10))
```
