...
As seen in Chapter \@ref(ch:Data), violin plots depict the distribution of a variable as a density plot reflected in the vertical axis. Figures \@ref(fig:violinall1) and \@ref(fig:violinall2) (below) contain violin plots of every socio-demographic variable. Note that these variables have not been standardised.
...
data_mod %>% 
  ...
  theme(axis.text.x = element_text(size = 14, angle = 75, vjust = 0.5), 
        axis.text.y = element_text(size=14), axis.title = element_text(size = 14)) + coord_fixed(0.05) + guides(fill = FALSE)
```
